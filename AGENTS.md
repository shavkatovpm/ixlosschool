...
## Loyiha qoidalari (Codex va Claude uchun)
...
- **Deploy workflow: `docs/deploy.md`** (hozir Vercel, keyinroq DigitalOcean droplet). Faqat egasi aniq "deploy" desa push qilinadi; commit/push'dan oldin o'sha faylni o'qing. Repozitoriy ochiq: xom manba papkalari (`/teachers/`, `/info/`, `/23.09/`, `/1 kun/`, `/Owner/`) va `.env*` hech qachon commit qilinmaydi.
