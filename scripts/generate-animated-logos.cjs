...
const animations = {
  "intro-01-signature-classic.svg": svg(
    `.draw{fill:transparent;stroke:#175c2b;stroke-width:10;stroke-linejoin:round;stroke-linecap:round;stroke-dasharray:1;stroke-dashoffset:1;animation:draw 4.8s cubic-bezier(.45,0,.25,1) .3s both}.fill{fill:#175c2b;opacity:0;animation:fill 1.1s ease 4.15s both}@keyframes draw{to{stroke-dashoffset:0}}@keyframes fill{to{opacity:1}}`,
    `${use('class="draw"')}${use('class="fill"')}`
  ),
  "intro-02-signature-staged.svg": svg(
    `.draw{fill:transparent;stroke:#175c2b;stroke-width:11;stroke-linejoin:round;stroke-linecap:round;stroke-dasharray:1;stroke-dashoffset:1}.laurel{animation:draw 3.3s ease .25s both}.center{animation:draw 2.5s ease 1.55s both}.word{animation:draw 2.4s ease 2.8s both}.fill{fill:#175c2b;opacity:0;animation:fill 1s ease 4.55s both}@keyframes draw{to{stroke-dashoffset:0}}@keyframes fill{to{opacity:1}}`,
  ...
  "intro-03-signature-dual.svg": svg(
    `.draw{fill:transparent;stroke:#175c2b;stroke-width:10;stroke-linejoin:round;stroke-linecap:round;stroke-dasharray:1;animation:draw 4.9s cubic-bezier(.5,0,.2,1) .25s both}.left{stroke-dashoffset:1}.right{stroke-dashoffset:-1}.fill{fill:#175c2b;opacity:0;animation:fill 1s ease 4.25s both}@keyframes draw{to{stroke-dashoffset:0}}@keyframes fill{to{opacity:1}}`,
  ...
  "intro-04-signature-ink.svg": svg(
    `.ghost{fill:transparent;stroke:#175c2b;stroke-width:4;opacity:.18}.ink{fill:transparent;stroke:#175c2b;stroke-width:7;stroke-linejoin:round;stroke-linecap:round;stroke-dasharray:1;stroke-dashoffset:1;animation:ink 5.6s cubic-bezier(.4,0,.2,1) .2s both}.fill{fill:#175c2b;opacity:0;animation:fill 1.2s ease 4.75s both}@keyframes ink{0%{stroke-dashoffset:1;stroke-width:4}75%{stroke-width:8}100%{stroke-dashoffset:0;stroke-width:13}}@keyframes fill{to{opacity:1}}`,
  ...
  "loader-01-scan-vertical.svg": svg(
    ...
    `<g mask="url(#mask)"><rect width="3601" height="3601" fill="#175c2b" opacity=".14"/><rect class="scan" width="3601" height="1050" y="1280" fill="url(#vertical)"/></g>`,
    `<mask id="mask">${use('fill="#fff"')}</mask><linearGradient id="vertical" x1="0" y1="0" x2="0" y2="1"><stop stop-color="transparent"/><stop offset=".5" stop-color="#175c2b"/><stop offset="1" stop-color="transparent"/></linearGradient>`
  ),
  "loader-02-scan-horizontal.svg": svg(
    ...
    `<g mask="url(#mask)"><rect width="3601" height="3601" fill="#175c2b" opacity=".14"/><rect class="scan" x="1280" width="1050" height="3601" fill="url(#horizontal)"/></g>`,
    `<mask id="mask">${use('fill="#fff"')}</mask><linearGradient id="horizontal"><stop stop-color="transparent"/><stop offset=".5" stop-color="#175c2b"/><stop offset="1" stop-color="transparent"/></linearGradient>`
  ),
  "loader-03-scan-dual.svg": svg(
    ...
    `<g mask="url(#mask)"><rect width="3601" height="3601" fill="#175c2b" opacity=".12"/><rect class="top" width="3601" height="760" y="1050" fill="url(#down)"/><rect class="bottom" width="3601" height="760" y="1790" fill="url(#up)"/></g>`,
    `<mask id="mask">${use('fill="#fff"')}</mask><linearGradient id="down" x1="0" y1="0" x2="0" y2="1"><stop stop-color="transparent"/><stop offset="1" stop-color="#175c2b"/></linearGradient><linearGradient id="up" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#175c2b"/><stop offset="1" stop-color="transparent"/></linearGradient>`
  ),
  "loader-04-scan-diagonal.svg": svg(
    ...
    `<g mask="url(#mask)"><rect width="3601" height="3601" fill="#175c2b" opacity=".12"/><rect class="scan" x="1280" y="-500" width="1050" height="4600" fill="url(#diagonal)"/></g>`,
  ...
  "loader-05-scan-radar.svg": svg(
    ...
    `<g mask="url(#mask)"><rect width="3601" height="3601" fill="#175c2b" opacity=".12"/><path class="radar" d="M1800 1800 L1800 -900 A2700 2700 0 0 1 3709 3709 Z" fill="url(#radarGradient)"/></g>`,
    `<mask id="mask">${use('fill="#fff"')}</mask><radialGradient id="radarGradient"><stop stop-color="#c8a45a"/><stop offset="1" stop-color="#175c2b" stop-opacity=".15"/></radialGradient>`
  ),
};
