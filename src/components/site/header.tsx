...
export function Header() {
  ...
  return (
    <HeaderShell>
      <div className="wrap flex h-[64px] items-center gap-2 !px-3 sm:h-[72px] min-[1200px]:grid min-[1200px]:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] min-[1200px]:h-[96px] min-[1200px]:!px-[clamp(20px,4.5vw,56px)] min-[1200px]:group-data-[scrolled=true]:h-[76px] transition-[height] duration-300 min-[1440px]:gap-4">
        <HomeLink>
          <Brand variant="header" />
        </HomeLink>

        <nav aria-label={t("mainLabel")} className="hidden items-center justify-center gap-2.5 text-[14px] min-[1200px]:flex min-[1366px]:gap-4 font-semibold">
          {items.map((l) => (
        ...
        <div className="ml-auto flex items-center gap-2 min-[1200px]:ml-0 min-[1200px]:justify-self-end min-[1200px]:gap-2 min-[1440px]:gap-3">
          <LocaleSwitcher />
          <ApplyTrigger
